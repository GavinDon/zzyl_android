...
public class BaseActivity_ViewBinding implements Unbinder {
  ...
  public BaseActivity_ViewBinding(final BaseActivity target, View source) {
    ...
    View view;
    target.mTitle = Utils.findRequiredViewAsType(source, R.id.app_txt, "field 'mTitle'", TextView.class);
    view = Utils.findRequiredView(source, R.id.tv_back, "method 'goBack'");
    view2131231146 = view;
